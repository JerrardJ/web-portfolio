...
function Github() {
  ...
  const repoInfo = repos.filter((r) => r.stargazers_count > 0).slice(0, 8);
  const theme = {
  ...
  return (
    <HelmetProvider>
      <Helmet>
        <title>Jerrard Joevin | Github</title>
      </Helmet>
      <div className="space-y-8 bg-mainBg p-4 md:p-8">
        <div className="flex h-24 max-w-full items-center justify-center gap-x-5 divide-x-2 divide-accentColor  rounded-lg bg-achievementBg">
