...
export const project = [
  {
    ...
    description:
      "Client : Thesis Project<br/>" +
      "Source : Bina Nusantara @Bandung<br/>" +
  ...
  },
  {
    title: "Smart Lamp",
    description:
      "Client : Human Computer Interaction Assignment<br/>" +
      "Source : Bina Nusantara @Bandung<br/>" +
      "Type : Team Project - 4 Person<br/>" +
      "Role : Wireframe & Mock Up Design & Front End Developer<br/><br/>" +
  ...
  },
  {
    title: "Pokemon Dex",
    description:
      "Client : Mobile Programming Assignment<br/>" +
      "Source : Bina Nusantara @Bandung<br/>" +
      "Type : Team Project - 4 Person<br/>" +
      "Role : Wireframe & Front End Mobile Programming<br/><br/>" +
  ...
  },
  {
    ...
    description:
      "Client : Augmented Reality Assignment<br/>" +
      "Source : Bina Nusantara @Bandung<br/>" +
      "Type : Team Project - 4 Person<br/>" +
      "Role : Wireframe & Front End Mobile Programming<br/><br/>" +
